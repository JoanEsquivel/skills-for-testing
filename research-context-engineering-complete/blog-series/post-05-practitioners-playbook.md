# The Practitioner's Playbook: Building Context-Efficient AI Applications

*Part 5 of 5 in the Context Engineering series*
...
### Essential Reading
- [Effective Context Engineering for AI Agents](https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents) — Anthropic's definitive guide
- [Context Rot: How Increasing Input Tokens Impacts LLM Performance](https://research.trychroma.com/context-rot) — Chroma's empirical research
- [Lost in the Middle](https://arxiv.org/abs/2307.03172) — Stanford's foundational paper
...
### Open Source
- [Awesome Context Engineering (yzfly)](https://github.com/yzfly/awesome-context-engineering)
...
*For the complete list of 100+ research sources, see [resources.md](../resources.md)*

*Back to [Part 4: Techniques for Efficient Context Usage](./post-04-techniques-for-efficiency.md)*

*Back to [Part 1: What Is Context Engineering?](./post-01-what-is-context-engineering.md)*
